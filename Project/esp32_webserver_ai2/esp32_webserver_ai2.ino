...
IPAddress local_IP(192, 168, 184, 144); 
// Gateway IP address
...
// If disconnected, try to reconnect every 30 seconds.
  ...
  if(req.indexOf("setforward") != -1)
  {
    response = "SET FORWARD";
    Serial2.write(0x10);
  }
  if(req.indexOf("clearforward") != -1)
  {
    response = "CLEAR FORWARD";
    Serial2.write(0x11);
  }  
  if(req.indexOf("setreverse") != -1)
  {
    response = "SET REVERSE";
    Serial2.write(0x12);
  }
  if(req.indexOf("clearreverse") != -1)
  {
    response = "CLEAR REVERSE";
    Serial2.write(0x13);
  }
  if(req.indexOf("setleft") != -1)
  {
    response = "SET LEFT";
    Serial2.write(0x14);
  }
  if(req.indexOf("clearleft") != -1)
  {
    response = "CLEAR LEFT";
    Serial2.write(0x15);
  }
  if(req.indexOf("setright") != -1)
  {
    response = "SET RIGHT";
    Serial2.write(0x16);
  }
  if(req.indexOf("clearright") != -1)
  {
    response = "CLEAR RIGHT";
    Serial2.write(0x17);
  }
  if(req.indexOf("sethardleft") != -1)
  {
    response = "SET HARD LEFT";
    Serial2.write(0x18);
  }
  if(req.indexOf("clearhardleft") != -1)
  {
    response = "CLEAR HARD LEFT";
    Serial2.write(0x19);
  }
  if(req.indexOf("sethardright") != -1)
  {
    response = "SET HARD RIGHT";
    Serial2.write(0x1A);
  }
  if(req.indexOf("clearhardright") != -1)
  {
    response = "CLEAR HARD RIGHT";
    Serial2.write(0x1B);
  }
  if(req.indexOf("setboost") != -1)
  {
    response = "SET BOOST";
    Serial2.write(0x1C);
  }
  if(req.indexOf("clearboost") != -1)
  {
    response = "CLEAR BOOST";
    Serial2.write(0x1D);
  }
  if(req.indexOf("setslow") != -1)
  {
    response = "SET SLOW";
    Serial2.write(0x1E);
  }
  if(req.indexOf("clearslow") != -1)
  {
    response = "CLEAR SLOW";
    Serial2.write(0x1F);
  }
  ...
  if(req.indexOf("fortyfiveleft") != -1)
  {
    response = "45 LEFT";
    Serial2.write(0x21);
  }
  if(req.indexOf("ninetyleft") != -1)
  {
    response = "90 LEFT";
    Serial2.write(0x22);
  }
  if(req.indexOf("fortyfiveright") != -1)
  {
    response = "45 RIGHT";
    Serial2.write(0x23);
  }
  if(req.indexOf("ninetyright") != -1)
  {
    response = "90 RIGHT";
    Serial2.write(0x24);
  }
